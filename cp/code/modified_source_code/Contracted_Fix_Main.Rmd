              ...
              data.sde <- data.sde %>%
                ...
                mutate(
                  ...
                  min_absdewma = suppressWarnings(min(absdewma[exclude %in% c("Exclude-Temporary-Extraneous-Same-Day",
                                                  "Include")],
                                                      na.rm = TRUE)),
                  min_absdewma = ifelse(is.infinite(min_absdewma), NA_real_, min_absdewma)) %>% ungroup() %>% mutate(
                  exclude = case_when(!is.na(min_absdewma) & min_absdewma > 2~"Exclude-SDE-EWMA-All-Extreme",
