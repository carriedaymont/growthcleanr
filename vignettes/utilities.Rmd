...
The CDC provides a
[SAS macro for computing BMI percentiles and Z-scores](https://www.cdc.gov/growth-chart-training/hcp/computer-programs/sas.html).
...
| mod_bmiz, mod_waz, mod_haz   | Modified BMI-for-age, Weight-for-age, and Height-for-age z-scores for identifying outliers (see the information in the [CDC SAS growth charts program website](https://www.cdc.gov/growth-chart-training/hcp/computer-programs/sas.html)) |
...
The CDC provides a
[SAS Program for the 2000 CDC Growth Charts](https://www.cdc.gov/growth-chart-training/hcp/computer-programs/sas.html)
