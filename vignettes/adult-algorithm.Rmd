...
*There will be notes in italics throughout the introductory material discussing
...
prior knowledge of growthcleanr-pediatrics*.
...
> *Growthcleanr-adult does not require sex, which is required for
...
> parameter as there is in some steps of growthcleanr-pediatrics.*
...
> *The expected patterns of WT and HT are two of the biggest differences with
...
> measurement error, not actual HT loss).*
...
> *Repeated values are different in very important ways from carried forwards in
...
> *There are important differences in EWMA between growthcleanr-adults and
...
> cms, and the cutoffs are very different than for pediatrics.*
...
of distinct WT 2. The formula is `wtallow = 4 +
18 * ln(1 + ageinterval [in months])`. If the absolute difference between WT1 and
